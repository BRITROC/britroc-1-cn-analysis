...
## Figure 5
fig5 <- plot_grid(plot_grid(signature_stacked_alt,
                  plot_grid(sig_box_paired_wilcox,empty,nrow = 2,labels = c("B","C")),
                  ncol = 2,
                  labels = c("A","")),nrow = 2,
                  plot_grid(sig_legend_a,sig_legend_b,ncol = 2,labels = c("","")),rel_heights = c(1,0.1))
ggsave2(filename = "figure_5_render.png",plot = fig5,width = 10,height = 9,units = "in",dpi = 300)  
...
ggsave2(filename = "figure_6_render.png",plot = fig5,width = 10,height = 10,units = "in",dpi = 300)

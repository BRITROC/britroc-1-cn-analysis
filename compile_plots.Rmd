...
flow_chart <- ggdraw() + draw_image(magick::image_read("plots/temp_Fig1A_flow_diagram.png",density = 600))
...
fig1 <- plot_grid(flow_chart,
                  ...
                  plot_grid(cohort_legend,
                            ...
                            ncol = 2),
                  labels = c("A","",""),
                  nrow = 3,rel_heights = c(0.4,0.4,0.2),align = "hv")

## Figure 1 render
ggsave2(filename = "plots/figure_1_render.png",plot = fig1,width = 9,height = 10,units = "in",dpi = 600)
ggsave2(filename = "plots/figure_1_render.pdf",plot = fig1,width = 9,height = 10,units = "in",dpi = 600)
fig1
```
...
substraction_plot <- ggdraw() + draw_image(magick::image_read_pdf("copy_number_analysis/broad_analysis/plots/genome_paired_substractionPlot.pdf",density = 600))
...
## TEMP
beta_bar_plot <- readRDS("plots/arx_relapse_bar_partialILR_beta.RDS")
...
## TEMP
fig5_alt <- plot_grid(plot_grid(signature_paired_line,
                  plot_grid(signature_stacked_alt,
                            beta_bar_plot,
                            ncol = 2,labels = c("B","C")),
                  nrow = 2,
...
ggsave2(filename = "plots/figure_5_alt_render.png",plot = fig5_alt,width = 9,height = 9,units = "in",dpi = 300)
ggsave2(filename = "plots/figure_5_alt_render.pdf",plot = fig5_alt,width = 9,height = 9,units = "in",dpi = 300)
fig5_alt
```
...
sig_primary_beta_results <- ggdraw() +
                              draw_image(magick::image_read("copy_number_signatures/plots/TEMP_primary_pt_sig_logR_partial_ILR_diagnosis_beta_values.png",
                                                      density = 600))
...
fig7 <- plot_grid(plot_grid(cn_focal_rate_primary_pt_diag,
                            sig_bar_plot_primary_pt_diag,
                            sig_dist_primary_pt_diag,
                            plot_grid(sig_primary_beta_results,empty,
                                      ncol = 2,labels = c("D","E")),
                    labels = c("A","B","C",""),
                    nrow = 4,
...
## Plot compile
ternary_all <- plot_grid(plotlist = plot.list,nrow = 7,ncol = 5)

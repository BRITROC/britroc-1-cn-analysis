...
fig1 <- plot_grid(flow_chart,
                  ...
                  plot_grid(cohort_legend,
                            ...
                            ncol = 2),
                  labels = c("A","",""),
                  nrow = 3,rel_heights = c(0.45,0.45,0.05))

## Figure 1 render
ggsave2(filename = "plots/figure_1_render.png",plot = fig1,width = 9,height = 8,units = "in",dpi = 600)
ggsave2(filename = "plots/figure_1_render.pdf",plot = fig1,width = 9,height = 8,units = "in",dpi = 600)
fig1
```

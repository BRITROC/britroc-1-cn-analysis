...
```{r fig9}
## BRCA figure
brca_rate_plot <- readRDS("copy_number_analysis/focal_analysis/plots/brca_cna_rates_plot.rds")
brca_sig_bar <- readRDS("copy_number_analysis/focal_analysis/plots/brca_sig_bar_plot.rds")
brca_sig_dist <- readRDS("copy_number_analysis/focal_analysis/plots/brca_sig_dist_grouped_plot.rds")
...
fig9 <- plot_grid(brca_rate_plot,
          brca_sig_dist,
          plot_grid(brca_sig_bar,brca_sig_radar,ncol = 2,labels=c("C","D")),
          brca_legend,
          labels=c("A","B","",""),
          nrow = 4,
          rel_heights = c(0.33,0.33,0.33,0.05))

ggsave2(filename = "plots/figure_9_render.png",plot = fig9,width = 8,height = 12,units = "in",dpi = 300)
ggsave2(filename = "plots/figure_9_render.pdf",plot = fig9,width = 8,height = 12,units = "in",dpi = 300)
fig9
```

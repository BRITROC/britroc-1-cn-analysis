...
sig_dist_primary_pt_diag <- sig_dist_primary_pt + theme(legend.position = "none",axis.text.x = element_blank())
...
## Figure 6 render
ggsave2(filename = "plots/figure_6_render.png",plot = fig6,width = 8,height = 12,units = "in",dpi = 300)
ggsave2(filename = "plots/figure_6_render.pdf",plot = fig6,width = 8,height = 12,units = "in",dpi = 300)
```
...
## Figure T1 compile
fig_S6 <- plot_grid(focal_heatmap_plot,focal_pairs_plot,nrow = 2,labels = c("A","B"))

...
ggsave(sig_immune_cor,filename = "plots/sig_immune_cor.png",width = 8,height = 10,units = "in",dpi = 300)
ggsave(sig_immune_cor,filename = "plots/sig_immune_cor.pdf",width = 8,height = 10,units = "in",dpi = 300)
sig_immune_cor
```
...
sig_immune_subset <- sig_immune %>%
                      filter(marker %in% c("CD8","CD3"))
```

```{r patient_sampling}
## Gather patient-sample table from long data
patient_groups <- sig_immune_subset %>%

...
## Take progression date closest to registration (TO BE REMOVED)
...
```{r add_surv_metrics}
# GEOFF CODE WITH POTENTIAL ERROR
...
sum_plot
saveRDS(object = sum_plot,file = "cohort_plot.RDS")
ggsave(filename = "cohort_summary_plot.png",plot = sum_plot,device = "png",width = 12,height = 9,dpi = "retina",units = "in")
```

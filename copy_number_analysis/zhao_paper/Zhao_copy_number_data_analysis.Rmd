...
```{r minimal_repo}
sample_ploidys <- c(sample1=4.2,sample2=2.8,sample3=3.6,sample4=3.2)
minimal_input <- data.frame(sample1 = c(6.2,3.1,0.6,2.5),
...
minimal_out <- data.frame(sample1 = c("N","N","DEL","N"),
           sample2 = c("N","DEL","N","N"),
...
Two issues have been identified; 1) calling of copy number alterations appears to be incorrect when using the availabe code (this will need to be validated by Zhao). 2) Incorrect genome build was used for the gene list used in the early-to-late stage paper resulting in inaccurate gene loci being used.

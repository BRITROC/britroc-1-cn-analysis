...
BriTROC samples (interesting and niche - see misc. fit notes presentation)
Scoring method (1-3 implementation for these samples - document written to describe work flow)
BRITROC-26
BRITROC-67
BRITROC-14
BRITROC-17 (Diploid to Tetraploid transition)
BRITROC-274 (Diploid to Tetraploid transition)
BRITROC-209 (Diploid to Triploid transition)
BRITROC-199 (Diploid to Triploid transition)
BRITROC-266 (Diploid to Tetraploid transition)
BRITROC-267
...
# ploidy_change_samples <- c("BRITROC-14",
#                            "BRITROC-17",
#                            "BRITROC-67",
#                            "BRITROC-26",
#                            "BRITROC-17",
...
ggplot(norm_paired_changes) +
  geom_col(aes(x = PATIENT_ID,y = change,group = gene)) +
  facet_wrap(. ~ gene) +
  theme_bw() +

...
```
Patient-specific alterations, while difficult to associate with specific clinical events or features as a singular observation, did demonstrate bioloigcally interesting genomic alterations. For example,  BRITROC-65 & BRITROC-37 demonstrated extreme gains of KRAS.


```{r patient_vignettes_2}

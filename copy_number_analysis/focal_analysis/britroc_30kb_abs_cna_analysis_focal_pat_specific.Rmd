...
```{r plot_vigs_2}
pat_vig_32 <- get_patient_vig(diff_matrix = diff_matrix,pat.name = "BRITROC-32")
pat_vig_32
```
...
pat_vig_246
ggsave(filename = "plots/patient_vignette_example.pdf",plot = pat_vig_246,width = 8, height = 11.3136)
```

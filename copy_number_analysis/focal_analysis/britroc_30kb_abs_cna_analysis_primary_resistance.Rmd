...
sig_bar$platinum_resistance <- ifelse(sig_bar$PATIENT_ID %in% primary_resist_pats$PATIENT_ID,"primary resistant","non-primary resistant")
head(sig_bar)
```

```{r cna_rate}
patient.meta$platinum_resistance <- ifelse(patient.meta$PATIENT_ID %in% primary_resist_pats$PATIENT_ID,
...
norm_amp_changes$platinum_resistant <- ifelse(norm_amp_changes$PATIENT_ID %in% primary_resist_pats$PATIENT_ID,
                                           "primary resistant","non-primary resistant")

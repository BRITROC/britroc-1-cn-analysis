...
gene_change_prior_lines <- ggplot(norm_amp_changes) +
...
ggsave(plot = gene_change_prior_lines,filename = "plots/gene_change_prior_lines_plot.pdf",width = 8,height = 6,units = "in",dpi = 300)

...
ggsave(plot = gene_change_prior_lines,filename = "plots/gene_change_prior_lines_plot.png",width = 8,height = 6,units = "in",dpi = 300)
ggsave(plot = gene_change_prior_lines,filename = "plots/gene_change_prior_lines_plot.pdf",width = 8,height = 6)
...
ggsave(plot = gene_change_pt_status,filename = "plots/gene_change_pt_status_plot.png",width = 8,height = 6,units = "in",dpi = 300)
ggsave(plot = gene_change_pt_status,filename = "plots/gene_change_pt_status_plot.pdf",width = 8,height = 6)
